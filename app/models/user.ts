...
export default class User extends compose(AppBaseModel, AuthFinder) {
    ...
    static async login(auth: Authenticator<Authenticators>, { email, password, remember }: Infer<typeof loginValidator>) {
    ...
    static async register(auth: Authenticator<Authenticators>, data: Infer<typeof registerValidator>) {
